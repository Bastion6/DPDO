<?php include ('../includes/header.php')?>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Registration </span>
                          <h3 class="card-title mb-2">Approved</h3>
                          <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> Success</small>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span>Renew</span>
                          <h3 class="card-title text-nowrap mb-1">4 days</h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Complaints</span>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Breaches</span>
    ...
    <div class="row"> -->
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title">
                                <h5 class="text-nowrap mb-2"> Report Profile</h5>
                                <span class="badge bg-label-warning rounded-pill">Year 2021 - 2022</span>
                              </div>
                              <div class="mt-sm-auto">
                                <small class="text-success text-nowrap fw-semibold"
                                  ><i class="bx bx-chevron-up"></i> 8.2%</small
                                >
                                <h3 class="mb-0">84</h3>
                              </div>
                            </div>
              ...
              <div class="col-md-8 col-lg-8 col-xl-4  mb-4">
              <div class="card">
                <h5 class="card-header">Oversight Staff</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Angela Betty</strong></td>
                        <td>Admin</td>
                        <td> angela@email.com</td>
                      
                      </tr>
                      <tr>
                        <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong>React Peter</strong></td>
                        <td>Super Admin</td>
                        <td>peter@admin.com                       
                        </td>
              ...
              <div class="col-md-6 col-lg-4 order-2 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Policies</h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="transactionID">
                          ...
                          <a class="dropdown-item" href="javascript:void(0);">Not Uploaded</a>
                        </div>
                      </div>
                    </div>
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <small class="text-muted d-block mb-1">14 Oct</small>
              ...
              <div class="col-md-6 col-lg-4 order-2 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Training</h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="transactionID">
                          <a class="dropdown-item" href="javascript:void(0);">14 days</a>
